            ...
            if self.config['train_type'] in ['nalgo','both']:
                ...
                for i in range(self.config['num_runs']):
                    ...
                    for epoch in range(self.config['max_epochs']):
                        ...
                        if not((epoch+1)%5) and self.config['epoch_logger']:
