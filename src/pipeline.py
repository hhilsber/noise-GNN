...
class Pipeline(object):
    ...
    def loop(self):
        ...
        if self.config['train_type'] in ['coteaching','both']:
            ...
            self.logger.info('Train coteaching')
